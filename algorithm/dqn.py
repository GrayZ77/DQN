...
class DQN:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.args.model_save_dir + '/evaluate_model/final_q_params.pkl'):
                path_q = self.args.model_save_dir + '/evaluate_model/final_q_params.pkl'
    ...
    def train(self, transitions, logger):
        ...
        with torch.no_grad():
            ...
            target_q = rewards + gamma * q_next * done_multiplier
